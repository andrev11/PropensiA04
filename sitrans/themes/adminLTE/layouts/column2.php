...
<aside class="main-sidebar">
     ...
     <!-- sidebar: style can be found in sidebar.less -->
        <section class="sidebar">
            ...
            ['label' => ThemeNav::link('Set ROP', 'fa fa-table'), 'url' => ['jenis/setrop'], 'visible'=>!Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'sales marketing'],
					  ['label' => ThemeNav::link('Produk', 'fa fa-table'), 'url' => ['produk/index'], 'visible'=>!Yii::$app->user->isGuest && Yii::$app->user->identity->role != 'admin'],
					  ...
					  ['label' => ThemeNav::link('CPO', 'fa fa-circle-o text-blue'), 'url' => ['../views/site/createpembelian.php'], 'visible'=>!Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'purchasing'],
