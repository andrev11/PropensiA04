     ...
     <!-- sidebar: style can be found in sidebar.less -->
        <section class="sidebar">
            ...
            ['label' => ThemeNav::link('Barang Keluar', 'fa fa-circle-o text-blue'), 'url' => ['penjualan/index2'], 'visible'=>!Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'admin inventori'],
					  ['label' => ThemeNav::link('Print Surat Jalan', 'fa fa-circle-o text-green'), 'url' => ['penjualan/index4'], 'visible'=>!Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'admin inventori'],
            ...
            ['label' => ThemeNav::link('Print Faktur Penjualan', 'fa fa-circle-o text-green'), 'url' => ['penjualan/index4'], 'visible'=>!Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'finance'],
                  ],
                ]);
            ?>
