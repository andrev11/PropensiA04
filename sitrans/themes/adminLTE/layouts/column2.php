            ...
            <?php
                echo Menu::widget([
                  ...
                  'items' => [
					  ...
					  ['label' => ThemeNav::link('Rekap Pembelian', 'fa fa-circle-o text-blue'), 'url' => ['pembelian/index3'], 'visible'=>!Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'bod'],
					  ['label' => ThemeNav::link('Rekap Penjualan', 'fa fa-circle-o text-blue'), 'url' => ['penjualan/index3'], 'visible'=>!Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'bod'],
					  ['label' => ThemeNav::link('Rekap Pembayaran Keluar', 'fa fa-circle-o text-red'), 'url' => ['pembayaran-out/index3'], 'visible'=>!Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'bod'],
					  ['label' => ThemeNav::link('Rekap Pembayaran Masuk', 'fa fa-circle-o text-red'), 'url' => ['pembayaran-in/index3'], 'visible'=>!Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'bod'],
					  ...
					  ['label' => ThemeNav::link('Faktur Pembayaran', 'fa fa-circle-o'), 'url' => ['penjualan/index4'], 'visible'=>!Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'finance'],
                  ],
                ]);
            ?>
			<?=Menu::widget([
