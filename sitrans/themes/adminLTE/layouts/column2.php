            ...
            <?php
                echo Menu::widget([
                  ...
                  'items' => [
					  ...
					  ['label' => ThemeNav::link('CPO', 'fa fa-circle-o text-green'), 'url' => ['../views/site/createpembelian.php'], 'visible'=>!Yii::$app->user->isGuest && Yii::$app->user->identity->role == 'purchasing'],
                  ],
                ]);
            ?>
